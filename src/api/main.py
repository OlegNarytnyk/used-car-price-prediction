...
PROCESSED_DATA_PATH = PROJECT_ROOT / "data" / "processed" / "ford_cleaned.csv"
...
def load_processed_data():
    if not PROCESSED_DATA_PATH.exists():
        raise HTTPException(
            status_code=500,
            detail="Processed dataset not found: data/processed/ford_cleaned.csv",
        )
